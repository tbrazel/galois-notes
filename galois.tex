...
We modify some notation slightly (e.g. $\Gr(k,n)$ instead of $G(k,n)$ for the Grassmannian of affine $k$-planes in affine $n$-space), but for the most part follow closely with the notation in \cite{Harris-Galois}.
